...
class StochasticConsistencyPolicy(BaseImagePolicy):
    def __init__(self, 
        ...
        #     global_cond_dim=global_cond_dim,
        #     diffusion_step_embed_dim=diffusion_step_embed_dim,
        #     diffusion_timestep = num_train_steps*16*10,
        #     down_dims=down_dims,
        ...
        #     input_dim = input_dim, local_cond_dim=None,
        #     global_cond_dim=global_cond_dim,diffusion_step_embed_dim=diffusion_step_embed_dim,
        #     diffusion_timestep = num_train_steps,down_dims=down_dims,
        #     kernel_size=kernel_size,n_groups=n_groups,
        #     cond_predict_scale=cond_predict_scale
        # )
