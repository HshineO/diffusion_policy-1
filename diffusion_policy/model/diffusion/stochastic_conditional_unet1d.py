...
class StochasticConditionalUnet1D(nn.Module):
    def __init__(self, 
        input_dim,
        local_cond_dim=None,
        ...
        diffusion_noise_encoder = nn.Sequential(
            nn.Linear(diffusion_timestep , 256*4),
            nn.Mish(),
            nn.Linear(256*4 , 256),
        )

        cond_dim = dsed + 256 #diffusion_timestep
        ...
        self.diffusion_noise_encoder = diffusion_noise_encoder
    ...
    def forward(self, 
        ...
        noise_sequence :(B,T,horizon,action_dim)
